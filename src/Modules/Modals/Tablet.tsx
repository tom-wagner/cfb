...
export const TeamModalTablet = ({ columnValuesObject, simulationResults, numberOfSimulations }: TeamModalProps) => {
  ...
  return (
    <Grid padded divided>
      ...
      <Grid.Row>
        <Table celled fixed unstackable style={{ maxWidth: '900px' }} compact>
          <Table.Header>
            <Table.Row>
